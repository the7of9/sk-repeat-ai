		...
		<div class="mt-20 flex flex-col items-center md:flex-row">
			{#each slice.items as item, index}
				{#if item.icon}
					...
					{/if}
					<div
						class="pulsing-icon flex aspect-square shrink-0 items-center justify-center rounded-full border border-violet-50/30 bg-violet-50/25 p-3 text-5xl text-violet-100 opacity-40 md:text-3xl"
					>
